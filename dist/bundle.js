...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__database__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__database___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__database__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Login_vue__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Register_vue__ = __webpack_require__(51);
...
let _ = __webpack_require__(10);
let low = __webpack_require__(46);

// var db = low('../../data/db.json');
let db = low('./db.json');
console.log(db);

let users = db.get('users').find({ id: 8 }).value();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_bootstrap__ = __webpack_require__(14);
...
var isPromise = __webpack_require__(44);
var memory = __webpack_require__(49);
var defaultStorage = __webpack_require__(48);
...
var update = __webpack_require__(13)("3e4b5e7f", content, false);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(13)("76b094f7", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
